...
class MovieTree
{
    ...
    private:
        ...
        void countMovieNodes(MovieNode *node, int *count); //number of unique titles in the tree
        void countLongestPath(MovieNode *node, int *max); //longest path from node to a leaf node in the tree
