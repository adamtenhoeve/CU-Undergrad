    ...
    ui(new Ui::PlotWindow)
{
    ...
    connect(t, &QTimer::timeout, this, &PlotWindow::timer_action);
...
//                grid[i][j]->set_color(QColor(254, 127, 156, 255));
            ...
            connect(grid[i][j], &Square::SquareLeftClicked,
                    this, &PlotWindow::SquareLeftClickedSlot);
            connect(grid[i][j], &Square::SquareRightClicked,
                    this, &PlotWindow::SquareRightClickedSlot);
    ...
    connect(ui->SpeedScrollBar, &QAbstractSlider::sliderMoved,
            this, &PlotWindow::on_SpeedScrollBar_sliderMoved);

    connect(ui->stepButton, &QAbstractButton::clicked,
            this, &PlotWindow::on_StepButton_clicked);

    connect(ui->playButton, &QAbstractButton::clicked,
            this, &PlotWindow::on_PlayButton_clicked);

    connect(ui->pauseButton, &QAbstractButton::clicked,
            this, &PlotWindow::on_PauseButton_clicked);

    connect(ui->skipButton, &QAbstractButton::clicked,
            this, &PlotWindow::on_SkipButton_clicked);
}
...
void PlotWindow::Update_Neighbors()
{
...
int PlotWindow::Find_Neighbors(int i, int j)
{
    int neighbors = 0;
    int topSide = j-1;
    int botSide = j+1;
...
void PlotWindow::on_SkipButton_clicked()
{
...
void PlotWindow::SquareLeftClickedSlot(Square *s)
{
...
void PlotWindow::SquareRightClickedSlot(Square *s)
{
...
void PlotWindow::on_SpeedScrollBar_sliderMoved(int position)
{
